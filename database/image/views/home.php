...
<div class="slider-container">
    <div class="slider">
        <img src="../database/image/slider/banner1.jpg" alt="Banner 1" class="slide">
        <img src="../database/image/slider/banner2.jpg" alt="Banner 2" class="slide">
        <img src="../database/image/slider/banner3.jpg" alt="Banner 3" class="slide">
        <img src="../database/image/slider/banner-giay-gucci.jpg" alt="Banner Gucci" class="slide">
    </div>
    ...
    if($products) {
        while($product = mysqli_fetch_array($products)) {
            try {
                ...
                echo "Lỗi khi xử lý sản phẩm: " . $e->getMessage();
            }
        }
    } else {
...
<div class="brand-section">
    ...
    <div class="brand-list">
        <img src="../database/image/brand/brand-1.jpg" alt="Brand 1">
        <img src="../database/image/brand/brand-2.jpg" alt="Brand 2">
        <img src="../database/image/brand/brand-3.jpg" alt="Brand 3">
        <img src="../database/image/brand/brand-4.jpg" alt="Brand 4">
        <img src="../database/image/brand/brand-5.jpg" alt="Brand 5">
        <img src="../database/image/brand/brand-6.png" alt="Brand 6">
        <img src="../database/image/brand/brand-7.png" alt="Brand 7">
    </div>
</div>
